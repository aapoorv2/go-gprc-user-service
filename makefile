...
.DEFAULT_GOAL := help
.PHONY: greet helloworld calculator help
project := greet calculator helloworld 
...
clean: clean_greet clean_calculator clean_helloworld ## Clean generated files
	${RM_F_CMD} ssl/*.crt
	${RM_F_CMD} ssl/*.csr
	${RM_F_CMD} ssl/*.key
	${RM_F_CMD} ssl/*.pem
...
clean_helloworld: ## Clean generated files for helloworld
	${RM_F_CMD} helloworld/${PROTO_DIR}/*.pb.go
